...
if Code.ensure_loaded?(Igniter) do
  defmodule Mix.Tasks.Workslot.Install do
    ...
    def igniter(igniter) do
      ...
      Working with coding agents? Add this to your agent instructions (CLAUDE.md / AGENTS.md)
      so they don't assume the defaults:

          This app uses Workslot: inside a git worktree the dev/test database names and the
